...
class Labyrinthe:
    ...
    def placer_murs_aleatoires(self, nb_murs):
        """Place des murs de manière aléatoire dans le labyrinthe"""
        for _ in range(nb_murs):
            x, y = random.randint(0, self.sizeX - 1), random.randint(0, self.sizeY - 1)
            self.matrice[y][x] = 1
